...
test("geohub - Hasengasse bug", {skip: false}, t => {
  ...
  const combinedCoords = featureUtils.combineSameTypeFeatures([buttomLine, rightLine, leftLine]);
  t.equals(combinedCoords.length, 17);
  t.equals(JSON.stringify(combinedCoords), "[[9.2195515,49.1440619],[9.2195749,49.1440446],[9.2196177,49.1440264]," +
